...
# This function works and achieves same output as compare_directories(),
# the only difference is in the type of output, data frame in new version, tibble in old version.
# To decide which one is better
new_compare_dir <- function(left_path,
                                    right_path,
                                    recurse    = TRUE,
                                    by_date    = TRUE,
                                    by_content = FALSE) {
