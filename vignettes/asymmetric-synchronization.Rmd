...
-   Make sure to set `by_date` and `by_content` arguments in `compare_directories()` the same way you pass them to the asymmetric synchronization functions.
...
+--------------------------------------------------------------------+-------------------------------------------------------------------------------------------------------------------------------------------------------------------------+---------------------------------------------------------------------------------------------------------------------------------+
| Partial asymmetric synchronization -common files:                  | -   if by date only: copy files that are newer in left to right                                                                                                         | no actions                                                                                                                      |
|                                                                    |                                                                                                                                                                         |                                                                                                                                 |
| **`common_files_asym_sync_to_right()`**                            | -   if by date and content: copy files that are newer and different in left to right                                                                                    |                                                                                                                                 |
|                                                                    |                                                                                                                                                                         |                                                                                                                                 |
...
syncdr.env.3 <- toy_dirs()

# Get left and right directories' paths 
left  <- syncdr.env.3$left
right <- syncdr.env.3$right
...
syncdr.env.4 <- toy_dirs()

# Get left and right directories' paths 
left  <- syncdr.env.4$left
right <- syncdr.env.4$right
