...
1.  Specify paths of both left and right directories, as well as the \`by_date\` and \`by_content\` arguments as you wish the synchronization to be performed OR

2.  Call the workhorse function \`compare_directories()\` first, and then provide the sync_status object it returns as input to the synchronization function
